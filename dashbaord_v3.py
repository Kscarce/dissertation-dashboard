...
with tabs[0]:
    ...
    if show_mit:
        ...
        missed_text = "That means the gap between women and men narrowed significantly after improvements were applied."
    else:
        standards_met = "2 of 6"
        female_recall = "63%"
        male_recall = "83%"
        female_color = FAIL_COLOR
        missed_text = "That means 1 in 3 women with heart disease was missed compared to 1 in 6 men."
    ...
    with col1:
        ...
        <div class='card' style='text-align:center; padding:2rem;'>
            <div class='kpi-label'>Fairness Standards Met</div>
    ...
    with col2:
        ...
        <div class='card' style='padding:1.5rem 2rem;'>
            <div class='kpi-label' style='margin-bottom:0.8rem;'>The Heart Disease Prediction Tool Correctly Identified</div>
...
with tabs[1]:
    ...
    Each criterion below defines what procedural fairness means in a healthcare AI context
    and shows whether the heart disease prediction tool met that standard.
    </p>
    """, unsafe_allow_html=True)
...
with tabs[2]:
    ...
    with col1:
        ...
        <div class='card'>
            ...
            <div style='font-size:0.8rem; color:#888; margin-bottom:0.6rem;'>
                Difference in how often men and women were flagged for heart disease
            </div>
    ...
    with col2:
        ...
        <div class='card'>
            ...
            <div style='font-size:0.8rem; color:#888; margin-bottom:0.6rem;'>
                Difference in how often men and women received incorrect results
            </div>
    ...
    <div class='tier-section'>
        ...
        <div style='display:grid; grid-template-columns:1fr 2fr; gap:1.5rem; align-items:center;'>
            ...
            <div style='font-size:0.82rem; color:#666; border-left:2px solid #eee; padding-left:1rem;'>
                This question maps to both Bias Suppression and Representativeness. Respondents were asked to choose between
                a tool that performs equally well for all patients and one that is more accurate overall but misses more women.
                This is one data point covering both rules.
            </div>
        </div>
    </div>
    """, unsafe_allow_html=True)
